...
void ParsedQuery::clear()
{
    ...
    this->crossTransposeFirstRelationName = "";
    this->crossTransposeSecondRelationName = "";
    ...
    // added group by variables
    this->groupResultantRelationName = "";
    this->groupFirstColumnName = "";
    this->groupSecondColumnName = "";
    this->groupRelationName = "";
    this->groupOperation = "";
           

    this->loadRelationName = "";
    this->loadType = ""; // added loadtype into clear
